...
class nn_mnist_classifier:
    def __init__(self, mmt_friction=0.9, lr=1e-2):
        ...
        # output 128
        self.fc1 = nnl.nn_fc_layer(input_size=28, output_size=128, filt_size=13)
    ...
    def backprop(self):
        ...
        # print('sm1_f :', sm1_f.shape, 'y shape : ', y.shape)
        cn_b = self.xent.backprop(sm1_f, y)
        # print('cn_b shape :', cn_b.shape, ' fc2_f shape : ', fc2_f.shape)
        # similarly, fill in ... part in the below
        sm1_b = self.sm1.backprop(fc2_f, cn_b)
        # print('sm1_b shape :', sm1_b.shape, ' ac2_f shape : ', ac2_f.shape)
        fc2_b, dldw_fc2, dldb_fc2 = self.fc2.backprop(ac2_f, sm1_b)
        # print('fc2_b shape :', fc2_b.shape, ' fc1_f shape : ', fc1_f.shape)
    ...
    def update_weights(self):
        ...
        self.fc2.update_weights(-self.v_w_fc2 * lr, -self.v_b_fc2 * lr)
        self.fc1.update_weights(-self.v_w_fc1 * lr, -self.v_b_fc1 * lr)
        # print('v_w_cv1 shape: ', self.v_w_cv1.shape)
        # print('v_b_cv1 shape: ', self.v_b_cv1.shape)
...
# n_train_sample = 500
# n_val_sample = int((len(y_train) - n_train_sample)/100)
